...
function(ADD_SIMULATION_TEST)
  ...
  if(ADD_SIM_TEST_PERFORMANCE AND NSYS_ANALYZE_PERFORMANCE_TESTS)
    set(RUN_NSYS TRUE)
  else()
    set(RUN_NSYS FALSE)
  endif()
  ...
  add_test(
    ...
    COMMAND
      ...
      -DPERF=${PERF} -DRUN_NSYS:BOOL=${RUN_NSYS} -DNSYS=${NSYS} -P ${PROJECT_SOURCE_DIR}/cmake/RunSimulation.cmake)
  ...
  # matches OUTPUT_DIR_PATH in RunSimulation.cmake
  set_tests_properties("${TEST_CATEGORY}.${IDF_NAME}" PROPERTIES EP_OUTPUT_DIR_PATH "${PROJECT_BINARY_DIR}/${TEST_FILE_FOLDER}/${IDF_NAME}/")
